...
class driveHandler:
    ...
    def setVelocity(self, x, y, theta=0):
        ...
        angcur = pi/3       # If robot is directed between +/- angcur, it walks in a curve
        angfwd = pi/12      # If robot is directed between +/- angfwd, it walks straight forward
