...
def _setVelocity(p, V, E, heading,E_prev,radius, last=False):
    """
...
def _buildTree(p,theta,vert, R, system, regionPoly,nextRegionPoly,isFreespace,q_gBundle, last=False):
